...
process.once("SIGTERM", async () => {
  logger.info("[MetricsQueue] SIGTERM received — flushing remaining metrics before shutdown");
  await batcher.flush("shutdown");
});

process.once("SIGINT", async () => {
  logger.info("[MetricsQueue] SIGINT received — flushing remaining metrics before shutdown");
  await batcher.flush("shutdown");
});
